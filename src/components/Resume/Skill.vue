      ...
      <div class="card-body px-3 px-md-5 py-5">
        ...
        <div class="mb-0">
          ...
          <div class="row row-cols-1 row-cols-md-3 mb-4">
            ...
            <div class="col mb-4 mb-md-0"><div class="d-flex align-items-center rounded-4 p-3 h-100">REST API</div></div>
            <div class="col"><div class="d-flex align-items-center rounded-4 p-3 h-100">Typescript</div></div>
          </div>
          <div class="row row-cols-1 row-cols-md-3">
            <div class="col mb-4 mb-md-0"><div class="d-flex align-items-center rounded-4 p-3 h-100">Redwood Js</div></div>
